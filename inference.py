...
#     # Replace this line with the modified code
...
#     # Calculate resizing parameters dynamically
#     frame_height, frame_width, _ = frm.shape
#     window_height, window_width, _ = window.shape

#     start_x = (window_width - frame_width) // 2
#     start_y = (window_height - frame_height) // 2
#     end_x = start_x + frame_width
#     end_y = start_y + frame_height

#     window[start_y:end_y, start_x:end_x, :] = frm
